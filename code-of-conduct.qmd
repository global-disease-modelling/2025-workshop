...
Violation of the Code of Conduct will result in verbal warnings, asking a participant to leave a session, or removal from the entire workshop. 

## Notes 

This Code of Conduct was inspired by the [rOpenSci Code of Conduct](https://ropensci.org/code-of-conduct/) and [WOMBAT 2024 Code of Conduct](https://wombat2024.numbat.space/code_of_conduct.html). 
