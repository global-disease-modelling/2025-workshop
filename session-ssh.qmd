...
1.  Check whether you already have SSH keys set up. How would you do this? Refer to [these instructions](ssh.qmd#sec-sshkeys).
2.  Set up your SSH key for Git. Refer to [these instructions](ssh.qmd#sec-ssh-git).
3.  Set up your SSH key for Pawsey. Refere to [these instructions](ssh.qmd#sec-ssh-pawsey).
